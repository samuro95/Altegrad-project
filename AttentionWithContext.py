...
class AttentionWithContext(Layer):
    ...
    def __init__(self, n_context_vect = 1, return_coefficients=False,
        ...
        self.n_context_vect = n_context_vect
    ...
    def build(self, input_shape):
        ...
        self.u = []
        for i in range(self.n_context_vect):
            u = self.add_weight((input_shape[-1],),
                                     initializer=self.init,
    ...
    def call(self, x, mask=None):
        ...
        uit = K.tanh(uit)
        ait_tab = [dot_product(uit, u) for u in self.u]
        ...
        if mask is not None:
            ...
            a_tab = [a*K.cast(mask, K.floatx()) for a in a_tab]
